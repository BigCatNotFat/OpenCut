...
- 素材预览支持保存多段选区，并按素材时间顺序连续插入时间线
- 素材预览支持 0.5×、1×、1.25×、1.5×、2× 和 3× 播放速度
- 参考 After Effects Footage 面板压缩为双层工具栏，多段列表默认收进弹出菜单
- 素材入点显示绿色竖线、出点显示红色竖线，保存后的多段边界可点击快速定位
- 素材预览默认连续播放，也可切换为仅播放当前入点到出点的选区模式
